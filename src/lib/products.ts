/**
 * ╔═══════════════════════════════════════════════════════════════════════════════╗
 * ║  Products / Catalog Store — Database Layer                                    ║
 * ║                                                                              ║
 * ║  Manages product configurations (SKU, fulfillmentType, locationId).          ║
 * ╚═══════════════════════════════════════════════════════════════════════════════╝
 */
...
export interface Product {
  ...
  price: number;
  qty: number;
  fulfillmentType: "Warehouse" | "VS";
  locationId: string; // F01, F02, MWO, or loc-XXX
